...
function EducationalOffer() {
    ...
    const getData = async () => {
      try {
        const response = await axios.get(
          "https://strapi.uagro.mx/api/niveles-superiores?limit=100&page=1&page=2"
        );
  ...
  return (
    <div className="w-full h-full px-12 py-2">
      ...
      {/* Contenedor principal del componente de escuela */}
      <div>
        {/* Video promocional de la region */}
        {/* <PromotionalVideo /> */}

        {/* Contenedor de cada escuela */}
        {filteredSchools.map((school) => (
          ...
          >
            ...
            <div className="px-4 py-4 h-full w-2/5">
              ...
              {/* Botones para compartir enlaces */}
