...
function BachOffer({region, search, schools, status}) {
  ...
  const filteredSchools = useMemo(() => {
    return schools.filter((school) => {
      const matchSearch = normalizeText(school.Bachilleratos).includes(
